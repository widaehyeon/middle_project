...
public class FileUploadServiceImpl implements IFileUploadService {
	...
	private String path = "D:\\team1\\source\\tour\\WebContent\\";
	//private String path = "C:\\Users\\PC-20\\highJava-workspace\\workspace\\tour\\WebContent\\";
//	private String path = "";
	private static final String SAVE_DIR = "resources/images/uploadPhoto";
...
//	      file = new File(path);
	...
	public FileUploadServiceImpl(String path) {
		file = new File(path);
	}
...
//	               String saveAtchFilePhoto = this.path + SAVE_DIR + File.separator + fileName;
	               
	               // 업로드 파일(원본파일) 저장
	               //path = "D:\\team1\\source\\tour\\WebContent\\resources";
	               //SAVE_DIR = "/images/uploadPhoto"
	               part.write(this.path + SAVE_DIR + File.separator + fileName);
	               //System.out.println("업로드 경로" + this.path + SAVE_DIR + File.separator + fileName);
	               //setFileService(SAVE_DIR + File.separator + fileName);
	               setFileService(SAVE_DIR + File.separator + fileName);
	               setFilePath(SAVE_DIR + "/" + fileName);
